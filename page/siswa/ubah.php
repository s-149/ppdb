                                ...
                                <div class="col-md-12">
                                    <form action="" method="POST" enctype="multipart/form-data" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="username" value="<?php echo $akun['UserName'];?>" readonly />
                                            
                                        </div>

                                        <div class="form-group">
                                            <label>Password</label>
                                            <input class="form-control" name="pass" type="password" id="pass" value="<?php echo $akun['Password'];?>"/>
