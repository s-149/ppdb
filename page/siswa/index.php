...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <div>
                <a href="cetak.php?page=siswa&aksi=semua" class="btn btn-warning" style="margin-top: 8px;" target="_blank"><i class="fa fa-print"></i> Cetak</a>
            </div><br>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $data['Tanggal_Diperbarui'];?></td>   
                         ...
                         <td>
                            <a href="?page=siswa&aksi=ubah&id=<?php echo $data['Nik_Siswa']; ?>" class="btn btn-warning" ><i class="fa fa-edit"></i> Ubah</a>
                            <a onclick="return confirm('Anda yakin ingin menghapus?')" href="?page=siswa&aksi=hapus&id=<?php echo $data['Nik_Siswa']; ?>" class="btn btn-danger" ><i class="fa fa-trash"></i> Hapus</a>
                            <a href="?page=siswa&aksi=detail&id=<?php echo $data['Nik_Siswa']; ?>" class="btn btn-primary" ><i class="fa fa-eye"></i> detail</a>
                            <a href="?page=siswa&aksi=rubah_tingkat1&id=<?php echo $data['Nik_Siswa']; ?>" class="btn btn-warning" ><i class="fa fa-edit"></i> Ubah Tingkat</a>
                            <a href="cetak.php?page=siswa&aksi=1&id=<?php echo $data['Nik_Siswa']; ?>" class="btn btn-warning"" target="_blank" class="btn btn-warning" style="margin-top: 8px;"><i class="fa fa-print"></i> Cetak</a>
