...
<?php
    $sql12 = $koneksi->query("select * from siswa");
    while ($data12= $sql12->fetch_assoc()) {
    $sql = $koneksi->query("select * from siswa where Nik_Siswa='$data12[Nik_Siswa]'");
    $data = $sql->fetch_assoc();
    $sql1 = $koneksi->query("select * from orang_tua_siswa where Nik_Siswa='$data12[Nik_Siswa]'");
    $orang_tua_siswa = $sql1->fetch_assoc();
    $sql2 = $koneksi->query("select * from asal_mula_siswa where Nik_Siswa='$data12[Nik_Siswa]'");
    ...
    $sql4 = $koneksi->query("select * from user where UserName='$data12[Nik_Siswa]'");
