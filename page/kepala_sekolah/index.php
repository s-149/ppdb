...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <div>
                <a href="?page=kepala_sekolah&aksi=tambah" class="btn btn-success" style="margin-top: 8px;"><i class="fa fa-plus"></i> Tambah Data</a>
            </div><br>
                    ...
                    <tr>
                        ...
                        <td><?php echo $data['Status'];?></td>
                         ...
                         <td>
                            ...
                            <a href="?page=kepala_sekolah&aksi=ubah&id=<?php echo $data['Nik_Pengajar']; ?>" class="btn btn-warning" ><i class="fa fa-edit"></i> Ubah</a>
                            <a onclick="return confirm('Anda yakin ingin menghapus?')" href="?page=kepala_sekolah&aksi=hapus&id=<?php echo $data['Nik_Pengajar']; ?>" class="btn btn-danger" ><i class="fa fa-trash"></i> Hapus</a>
