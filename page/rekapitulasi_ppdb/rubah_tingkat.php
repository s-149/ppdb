                            ...
                            if ($tingkat=='baru' or $tingkat=='diterima' or $tingkat=='aktif') 
                                {
                                    ...
                                    $sql = $koneksi->query("update  siswa set `Status_Siswa`='$tingkat' where `Kelas`='1'");
                                }

                            if ($tingkat=='1' or $tingkat=='2' or $tingkat=='3' or $tingkat=='4' or $tingkat=='5' or $tingkat=='6') 
                                {
                                    //menjalankan perintah
                                    $sql = $koneksi->query("update  siswa set `Status_Siswa`='aktif',`Kelas`='$tingkat' where `Kelas`='1'");
                                }
                            if ($tingkat=='lulus') 
                                {
                                    //menjalankan perintah
                                    $sql = $koneksi->query("update  siswa set `Status_Siswa`='$tingkat',`Kelas`='alumni' where `Kelas`='1'");
                                }
