    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h4>Kelengkapan Berkas:</h4>
                <div class="table-responsive">
                    <div>
                        <a href="?page=berhenti&aksi=tambah_kelengkapan&id=<?php echo $data['Nik_Siswa'];?>" class="btn btn-success" style="margin-top: 8px;"><i class="fa fa-plus"></i> Tambah Berkas</a>
                    </div><br>
            ...
            <h4>Akun User:</h4>
                <label>
                    <a href="?page=berhenti&aksi=rubah_akun&id=<?php echo $akun['UserName']; ?>" class="btn btn-warning" ><i class="fa fa-edit"></i> Rubah Akun</a>
                </label>
                <div class="table-responsive">
                    <table class="table">
                        <tr>
