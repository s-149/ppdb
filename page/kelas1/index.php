...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <div>
                <a href="?page=kelas1&aksi=rubah_tingkat" class="btn btn-warning" style="margin-top: 8px;"><i class="fa fa-edit"></i> Ubah Tingkat</a>
            </div><br>
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        $sql = $koneksi->query("select * from siswa where Status_Siswa='aktif' and Kelas='kelas1' ");
                    ...
                    <tr>
                        ...
                        <td><?php echo $data['Tanggal_Diperbarui'];?></td>   
                         ...
                         <td>
                            <a href="?page=kelas1&aksi=ubah&id=<?php echo $data['Nik_Siswa']; ?>" class="btn btn-warning" ><i class="fa fa-edit"></i> Ubah</a>
                            <a onclick="return confirm('Anda yakin ingin menghapus?')" href="?page=kelas1&aksi=hapus&id=<?php echo $data['Nik_Siswa']; ?>" class="btn btn-danger" ><i class="fa fa-trash"></i> Hapus</a>
                            <a href="?page=kelas1&aksi=detail&id=<?php echo $data['Nik_Siswa']; ?>" class="btn btn-primary" ><i class="fa fa-eye"></i> detail</a>
                            <a href="?page=kelas1&aksi=rubah_tingkat1&id=<?php echo $data['Nik_Siswa']; ?>" class="btn btn-warning" ><i class="fa fa-edit"></i> Ubah Tingkat</a>
