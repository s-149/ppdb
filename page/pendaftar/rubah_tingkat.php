    ...
    if ($simpan) {
                            ...
                            if ($tingkat=='baru' or $tingkat=='diterima' or $tingkat=='aktif') 
                                {
                                    ...
                                    $sql = $koneksi->query("update  siswa set `Status_Siswa`='$tingkat' where `Status_Siswa`='baru'");
                                }

                            if ($tingkat=='kelas1' or $tingkat=='kelas2' or $tingkat=='kelas3' or $tingkat=='kelas4' or $tingkat=='kelas5' or $tingkat=='kelas6') 
                                {
                                    //menjalankan perintah
                                    $sql = $koneksi->query("update  siswa set `Status_Siswa`='aktif',`Kelas`='$tingkat' where `Status_Siswa`='baru'");
                                }
                            if ($tingkat=='lulus') 
                                {
                                    //menjalankan perintah
                                    $sql = $koneksi->query("update  siswa set `Status_Siswa`='$tingkat',`Kelas`='alumni' where `Status_Siswa`='baru'");
                                }
            ...
            ?>
                <script type="text/javascript">
                    ...
                    window.location.href="?page=pendaftar";
