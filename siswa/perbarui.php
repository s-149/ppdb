    ...
    <section class="blog_part section_padding" id="perbarui">
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-lg-7 mb-5 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
                    <img src="gambar/background/daftar.png" alt="Image" class="img-fluid">
                </div>
                <div class="col-lg-4 mr-auto order-2 order-lg-1"  data-aos="fade-up" data-aos-delay="100">
                    <h2 class="text-black mb-4">
                        PERBARUI ISI FORMULIR
                    </h2>
                    <p align="justify">
                        Silahkan isi Formulir PPDB dibawah dengan data yang lengkap dan benar.
                        Ingat.!!! Nik akan tersambung dengan data yg lain, Silahkan Perbarui data anda agar tidak keliru...
                    </p>
                </div>
            </div>
