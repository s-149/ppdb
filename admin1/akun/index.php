...
<div class="panel-body">
    <div class="row">
        <div class="col-md-12">
            <div>
                <a href="?page=akun&aksi=ubah_password&id=<?=$id; ?>" class="btn btn-warning" style="margin-top: 8px;"><i class="fa fa-edit"></i> Ubah Password</a>
            </div><br>
            <div>
                <a href="?page=akun&aksi=ubah_fhoto&id=<?=$id; ?>" class="btn btn-warning" style="margin-top: 8px;"><i class="fa fa-edit"></i> Ubah Fhoto</a>
            </div><br>
